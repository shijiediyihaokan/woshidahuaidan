...
window.AdminEditor = (function() {
  ...
  function renderInsertPoint(afterIdx) {
    return '<div class="insert-point" data-after="'+afterIdx+'" style="text-align:center;padding:4px 0">'+
    ...
    switch(m.type){
      ...
      case'specs':
        ...
        for(var si=0;si<sRows.length;si++){
          ...
          h+='<div style="display:flex;gap:6px;margin-bottom:4px;align-items:center">';
          h+='<input type="text" value="'+(sRow.name||'')+'" placeholder="参数名" onchange="__vizData['+idx+'].data.rows['+si+'].name=this.value" style="flex:1;padding:6px 8px;border:1px solid #e5e7eb;border-radius:4px;font-size:12px">';
          h+='<input type="text" value="'+(sRow.value||'')+'" placeholder="数值" onchange="__vizData['+idx+'].data.rows['+si+'].value=this.value" style="flex:1;padding:6px 8px;border:1px solid #e5e7eb;border-radius:4px;font-size:12px">';
      ...
      case'faq':
        ...
        for(var qi=0;qi<qItems.length;qi++){
          ...
          h+='<input type="text" value="'+(qItem.q||'')+'" placeholder="问题" onchange="__vizData['+idx+'].data.items['+qi+'].q=this.value" style="width:100%;padding:6px 8px;border:1px solid #e5e7eb;border-radius:4px;font-size:12px;font-weight:600;margin-bottom:4px">';
      ...
      case'table':
        ...
        for(var ti=0;ti<tRows.length;ti++){
          ...
          for(var tj=0;tj<tCols;tj++){
            ...
            h+='<td style="padding:2px;border:1px solid #eee"><input type="text" value="'+cell.replace(/"/g,'&quot;')+'" placeholder="单元格" onchange="if(!__vizData['+idx+'].data.rows['+ti+'])__vizData['+idx+'].data.rows['+ti+']=[];__vizData['+idx+'].data.rows['+ti+']['+tj+']=this.value" style="width:100%;padding:4px 6px;border:1px solid #e5e7eb;border-radius:3px;font-size:11px"></td>';
          }
      ...
      case'cta':
        ...
        h+='<input type="text" value="'+(d.email||'')+'" placeholder="邮箱" onchange="__vizData['+idx+'].data.email=this.value" style="flex:1;padding:6px 8px;border:1px solid #e5e7eb;border-radius:4px;font-size:12px">';
        h+='<input type="text" value="'+(d.phone||'')+'" placeholder="电话" onchange="__vizData['+idx+'].data.phone=this.value" style="flex:1;padding:6px 8px;border:1px solid #e5e7eb;border-radius:4px;font-size:12px">';
        h+='</div>';
        h+='</div></div>';
        break;
